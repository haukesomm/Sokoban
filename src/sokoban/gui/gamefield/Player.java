...
public class Player extends MovableObject {
    ...
    public void setDirection(int direction) {
        ...
        switch (direction) {
            case 0:
                setIcon(new ImageIcon(getClass().getResource("/sokoban/resources/textures/player0.png")));
                break;
            case 1:
                setIcon(new ImageIcon(getClass().getResource("/sokoban/resources/textures/player1.png")));
                break;
            case 2:
                setIcon(new ImageIcon(getClass().getResource("/sokoban/resources/textures/player2.png")));
                break;
            case 3:
                setIcon(new ImageIcon(getClass().getResource("/sokoban/resources/textures/player3.png")));
                break;
        }
