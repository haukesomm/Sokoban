...
import sokoban.SettingsManager;
import sokoban.ErrorWindow;
import sokoban.gui.gamefield.MoveAction;
...
public class Game extends JFrame {
    ...
    private void initializeFrame() {
        ...
        setIconImage(new ImageIcon(getClass().getResource("/sokoban/resources/textures/box.png")).getImage());
