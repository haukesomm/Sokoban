 ...
 * fritz2-compatible definitions derived from [fritz2](https://github.com/jwstegemann/fritz2).
 *
 * License: https://github.com/tailwindlabs/heroicons/blob/master/LICENSE
 */
object HeroIcons {
    val academic_cap = IconDefinition(24, 24, """
    ...
    val adjustments = IconDefinition(24, 24, """
    ...
    val `annotation` = IconDefinition(24, 24, """
    ...
    val archive = IconDefinition(24, 24, """
    ...
    val arrow_circle_down = IconDefinition(24, 24, """
    ...
    val arrow_circle_left = IconDefinition(24, 24, """
    ...
    val arrow_circle_right = IconDefinition(24, 24, """
    ...
    val arrow_circle_up = IconDefinition(24, 24, """
    ...
    val at_symbol = IconDefinition(24, 24, """
    ...
    val backspace = IconDefinition(24, 24, """
    ...
    val badge_check = IconDefinition(24, 24, """
    ...
    val beaker = IconDefinition(24, 24, """
    ...
    val bookmark = IconDefinition(24, 24, """
    ...
    val briefcase = IconDefinition(24, 24, """
    ...
    val calculator = IconDefinition(24, 24, """
    ...
    val calendar = IconDefinition(24, 24, """
        <path d="M8 7V3M16 7V3M7 11H17M5 21H19C20.1046 21 21 20.1046 21 19V7C21 5.89543 20.1046 5 19 5H5C3.89543 5 3 5.89543 3 7V19C3 20.1046 3.89543 21 5 21Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    """.trimIndent())

    val camera = IconDefinition(24, 24, """
    ...
    val chart_bar = IconDefinition(24, 24, """
    ...
    val chart_pie = IconDefinition(24, 24, """
    ...
    val chart_square_bar = IconDefinition(24, 24, """
    ...
    val chat_alt_2 = IconDefinition(24, 24, """
    ...
    val chat_alt = IconDefinition(24, 24, """
    ...
    val clipboard_check = IconDefinition(24, 24, """
    ...
    val clipboard_copy = IconDefinition(24, 24, """
    ...
    val clipboard_list = IconDefinition(24, 24, """
        <path d="M9 5H7C5.89543 5 5 5.89543 5 7V19C5 20.1046 5.89543 21 7 21H17C18.1046 21 19 20.1046 19 19V7C19 5.89543 18.1046 5 17 5H15M9 5C9 6.10457 9.89543 7 11 7H13C14.1046 7 15 6.10457 15 5M9 5C9 3.89543 9.89543 3 11 3H13C14.1046 3 15 3.89543 15 5M12 12H15M12 16H15M9 12H9.01M9 16H9.01" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    """.trimIndent())

    val clipboard = IconDefinition(24, 24, """
        <path d="M9 5H7C5.89543 5 5 5.89543 5 7V19C5 20.1046 5.89543 21 7 21H17C18.1046 21 19 20.1046 19 19V7C19 5.89543 18.1046 5 17 5H15M9 5C9 6.10457 9.89543 7 11 7H13C14.1046 7 15 6.10457 15 5M9 5C9 3.89543 9.89543 3 11 3H13C14.1046 3 15 3.89543 15 5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    """.trimIndent())

    val clock = IconDefinition(24, 24, """
        <path d="M12 8V12L15 15M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    """.trimIndent())

    val cloud_download = IconDefinition(24, 24, """
    ...
    val cloud_upload = IconDefinition(24, 24, """
    ...
    val cloud = IconDefinition(24, 24, """
    ...
    val collection = IconDefinition(24, 24, """
        <path d="M19 11H5M19 11C20.1046 11 21 11.8954 21 13V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V13C3 11.8954 3.89543 11 5 11M19 11V9C19 7.89543 18.1046 7 17 7M5 11V9C5 7.89543 5.89543 7 7 7M7 7V5C7 3.89543 7.89543 3 9 3H15C16.1046 3 17 3.89543 17 5V7M7 7H17" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    """.trimIndent())

    val color_swatch = IconDefinition(24, 24, """
    ...
    val credit_card = IconDefinition(24, 24, """
    ...
    val cube_transparent = IconDefinition(24, 24, """
    ...
    val cube = IconDefinition(24, 24, """
        <path d="M20 7L12 3L4 7M20 7L12 11M20 7V17L12 21M12 11L4 7M12 11V21M4 7V17L12 21" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    """.trimIndent())

    val currency_bangladeshi = IconDefinition(24, 24, """
    ...
    val currency_dollar = IconDefinition(24, 24, """
    ...
    val currency_euro = IconDefinition(24, 24, """
    ...
    val currency_pound = IconDefinition(24, 24, """
    ...
    val currency_rupee = IconDefinition(24, 24, """
    ...
    val currency_yen = IconDefinition(24, 24, """
    ...
    val cursor_click = IconDefinition(24, 24, """
    ...
    val database = IconDefinition(24, 24, """
    ...
    val desktop_computer = IconDefinition(24, 24, """
    ...
    val device_mobile = IconDefinition(24, 24, """
    ...
    val device_tablet = IconDefinition(24, 24, """
    ...
    val document_add = IconDefinition(24, 24, """
    ...
    val document_download = IconDefinition(24, 24, """
    ...
    val document_duplicate = IconDefinition(24, 24, """
    ...
    val document_remove = IconDefinition(24, 24, """
    ...
    val document_report = IconDefinition(24, 24, """
    ...
    val document_search = IconDefinition(24, 24, """
    ...
    val document_text = IconDefinition(24, 24, """
        <path d="M9 12H15M9 16H15M17 21H7C5.89543 21 5 20.1046 5 19V5C5 3.89543 5.89543 3 7 3H12.5858C12.851 3 13.1054 3.10536 13.2929 3.29289L18.7071 8.70711C18.8946 8.89464 19 9.149 19 9.41421V19C19 20.1046 18.1046 21 17 21Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    """.trimIndent())

    val document = IconDefinition(24, 24, """
    ...
    val dots_circle_horizontal = IconDefinition(24, 24, """
    ...
    val download = IconDefinition(24, 24, """
    ...
    val duplicate = IconDefinition(24, 24, """
    ...
    val emoji_happy = IconDefinition(24, 24, """
    ...
    val emoji_sad = IconDefinition(24, 24, """
    ...
    val exclamation_circle = IconDefinition(24, 24, """
        <path d="M12 8V12M12 16H12.01M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    """.trimIndent())

    val exclamation = IconDefinition(24, 24, """
    ...
    val external_link = IconDefinition(24, 24, """
    ...
    val eye_off = IconDefinition(24, 24, """
    ...
    val fast_forward = IconDefinition(24, 24, """
    ...
    val filter = IconDefinition(24, 24, """
    ...
    val finger_print = IconDefinition(24, 24, """
    ...
    val folder_add = IconDefinition(24, 24, """
    ...
    val folder_download = IconDefinition(24, 24, """
    ...
    val folder_open = IconDefinition(24, 24, """
    ...
    val folder_remove = IconDefinition(24, 24, """
    ...
    val folder = IconDefinition(24, 24, """
    ...
    val hashtag = IconDefinition(24, 24, """
    ...
    val inbox_in = IconDefinition(24, 24, """
    ...
    val inbox = IconDefinition(24, 24, """
    ...
    val information_circle = IconDefinition(24, 24, """
        <path d="M13 16H12V12H11M12 8H12.01M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    """.trimIndent())

    val key = IconDefinition(24, 24, """
    ...
    val library = IconDefinition(24, 24, """
    ...
    val light_bulb = IconDefinition(24, 24, """
    ...
    val lock_closed = IconDefinition(24, 24, """
    ...
    val lock_open = IconDefinition(24, 24, """
    ...
    val login = IconDefinition(24, 24, """
    ...
    val logout = IconDefinition(24, 24, """
    ...
    val mail_open = IconDefinition(24, 24, """
    ...
    val minus_circle = IconDefinition(24, 24, """
    ...
    val music_note = IconDefinition(24, 24, """
    ...
    val newspaper = IconDefinition(24, 24, """
    ...
    val office_building = IconDefinition(24, 24, """
    ...
    val paper_airplane = IconDefinition(24, 24, """
    ...
    val paper_clip = IconDefinition(24, 24, """
    ...
    val pause = IconDefinition(24, 24, """
    ...
    val pencil_alt = IconDefinition(24, 24, """
    ...
    val pencil = IconDefinition(24, 24, """
    ...
    val phone_incoming = IconDefinition(24, 24, """
    ...
    val phone_missed_call = IconDefinition(24, 24, """
    ...
    val phone_outgoing = IconDefinition(24, 24, """
    ...
    val plus_circle = IconDefinition(24, 24, """
    ...
    val plus_sm = IconDefinition(24, 24, """
    ...
    val presentation_chart_line = IconDefinition(24, 24, """
    ...
    val printer = IconDefinition(24, 24, """
    ...
    val puzzle = IconDefinition(24, 24, """
    ...
    val qrcode = IconDefinition(24, 24, """
    ...
    val question_mark_circle = IconDefinition(24, 24, """
    ...
    val receipt_refund = IconDefinition(24, 24, """
    ...
    val receipt_tax = IconDefinition(24, 24, """
    ...
    val refresh = IconDefinition(24, 24, """
        <path d="M4 4V9H4.58152M19.9381 11C19.446 7.05369 16.0796 4 12 4C8.64262 4 5.76829 6.06817 4.58152 9M4.58152 9H9M20 20V15H19.4185M19.4185 15C18.2317 17.9318 15.3574 20 12 20C7.92038 20 4.55399 16.9463 4.06189 13M19.4185 15H15" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    """.trimIndent())

    val reply = IconDefinition(24, 24, """
    ...
    val rewind = IconDefinition(24, 24, """
    ...
    val save_as = IconDefinition(24, 24, """
    ...
    val scale = IconDefinition(24, 24, """
    ...
    val scissors = IconDefinition(24, 24, """
    ...
    val search_circle = IconDefinition(24, 24, """
    ...
    val share = IconDefinition(24, 24, """
    ...
    val shield_check = IconDefinition(24, 24, """
    ...
    val shield_exclamation = IconDefinition(24, 24, """
    ...
    val shopping_bag = IconDefinition(24, 24, """
    ...
    val shopping_cart = IconDefinition(24, 24, """
        <path d="M3 3H5L5.4 5M7 13H17L21 5H5.4M7 13L5.4 5M7 13L4.70711 15.2929C4.07714 15.9229 4.52331 17 5.41421 17H17M17 17C15.8954 17 15 17.8954 15 19C15 20.1046 15.8954 21 17 21C18.1046 21 19 20.1046 19 19C19 17.8954 18.1046 17 17 17ZM9 19C9 20.1046 8.10457 21 7 21C5.89543 21 5 20.1046 5 19C5 17.8954 5.89543 17 7 17C8.10457 17 9 17.8954 9 19Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    """.trimIndent())

    val sort_ascending = IconDefinition(24, 24, """
    ...
    val sort_descending = IconDefinition(24, 24, """
    ...
    val sparkles = IconDefinition(24, 24, """
    ...
    val speakerphone = IconDefinition(24, 24, """
    ...
    val status_offline = IconDefinition(24, 24, """
    ...
    val status_online = IconDefinition(24, 24, """
    ...
    val support = IconDefinition(24, 24, """
    ...
    val switch_horizontal = IconDefinition(24, 24, """
    ...
    val switch_vertical = IconDefinition(24, 24, """
    ...
    val table = IconDefinition(24, 24, """
    ...
    val template = IconDefinition(24, 24, """
    ...
    val terminal = IconDefinition(24, 24, """
    ...
    val thumb_down = IconDefinition(24, 24, """
    ...
    val thumb_up = IconDefinition(24, 24, """
    ...
    val ticket = IconDefinition(24, 24, """
        <path d="M15 5V7M15 11V13M15 17V19M5 5C3.89543 5 3 5.89543 3 7V10C4.10457 10 5 10.8954 5 12C5 13.1046 4.10457 14 3 14V17C3 18.1046 3.89543 19 5 19H19C20.1046 19 21 18.1046 21 17V14C19.8954 14 19 13.1046 19 12C19 10.8954 19.8954 10 21 10V7C21 5.89543 20.1046 5 19 5H5Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    """.trimIndent())

    val translate = IconDefinition(24, 24, """
    ...
    val trash = IconDefinition(24, 24, """
        <path d="M19 7L18.1327 19.1425C18.0579 20.1891 17.187 21 16.1378 21H7.86224C6.81296 21 5.94208 20.1891 5.86732 19.1425L5 7M10 11V17M14 11V17M15 7V4C15 3.44772 14.5523 3 14 3H10C9.44772 3 9 3.44772 9 4V7M4 7H20" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    """.trimIndent())

    val trending_down = IconDefinition(24, 24, """
    ...
    val trending_up = IconDefinition(24, 24, """
    ...
    val truck = IconDefinition(24, 24, """
    ...
    val upload = IconDefinition(24, 24, """
    ...
    val user_add = IconDefinition(24, 24, """
    ...
    val user_circle = IconDefinition(24, 24, """
    ...
    val user_group = IconDefinition(24, 24, """
    ...
    val user_remove = IconDefinition(24, 24, """
    ...
    val variable = IconDefinition(24, 24, """
    ...
    val video_camera = IconDefinition(24, 24, """
    ...
    val view_boards = IconDefinition(24, 24, """
    ...
    val view_grid_add = IconDefinition(24, 24, """
    ...
    val view_grid = IconDefinition(24, 24, """
    ...
    val volume_up = IconDefinition(24, 24, """
    ...
    val x_circle = IconDefinition(24, 24, """
